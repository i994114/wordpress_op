...
<?php get_template_part('content', 'menu'); ?>
        ...
        <!--メインビジュアル画像-->
        <div id="main_visual">
            <img src="/img/main_visual.jpg" alt="健やかな健康と豊かな食生活をはじめる">
        </div>
        <!--wrapperー-->
        <div id="wrapper">
            <!--メイン-->
            <div id="main">
                <section id="point">
                    ...
                    <section>
                        <h3>食卓を豊かにしたい</h3>
                        <figure>
                            <img src="img/photo01.jpg" alt="TechAcademy KITCHENについて1">
                    ...
                    <section>
                        <h3>豊かな食生活を応援したい</h3>
                        <figure>
                            <img src="img/photo02.jpg" alt="TechAcademy KITCHENについて2">
            ...
            <aside id="sidebar">
                <section id="side_banner">
                    ...
                    <ul>
                        <li>
                            <a href="https://techacademy.jp/magazine/" target="_blank"><img src="img/banner01.jpg" alt="ブログ"></a>
